<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app_rej.aspx.cs" Inherits="e_leave_V.md.app_rej" MasterPageFile="~/md/MdMaster.Master" %>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <asp:GridView ID="grd_app_rej" runat="server" CssClass="table table-striped table-bordered dt-responsive nowrap" AutoGenerateColumns="False" DataKeyNames="lid" OnPreRender="grd_app_rej_PreRender">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="arrange">
                                        <asp:Button ID="btnaccept" runat="server" Text="Approve" CssClass="btn btn-success" OnClick="btnaccept_Click" CausesValidation="False" />
