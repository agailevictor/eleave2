<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="e_leave_V._404" %>
                        ...
                        <svg class="svg-box" width="380px" height="500px" viewBox="0 0 837 1045" version="1.1"
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                ...
                                <path d="M773,186 L827,217.538705 L827,279.636651 L773,310 L719,279.636651 L719,217.538705 L773,186 Z"
                                    id="Polygon-3" stroke="#f76397" stroke-width="6" sketch:type="MSShapeGroup">
                                </path>
                                <path d="M639,529 L773,607.846761 L773,763.091627 L639,839 L505,763.091627 L505,607.846761 L639,529 Z"
                                    id="Polygon-4" stroke="#00b19d" stroke-width="6" sketch:type="MSShapeGroup">
                                </path>
                                <path d="M281,801 L383,861.025276 L383,979.21169 L281,1037 L179,979.21169 L179,861.025276 L281,801 Z"
                                    id="Polygon-5" stroke="#ffaa00" stroke-width="6" sketch:type="MSShapeGroup">
                                </path>
                            </g>
                        </svg>
                    </div>
                        ...
                        <div class="message-box">
                            ...
                            <div class="buttons-con">
                                <div class="action-link-wrap">
                                    <a href="MainPage" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Go to Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
