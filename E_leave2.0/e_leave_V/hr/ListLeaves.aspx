<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListLeaves.aspx.cs" Inherits="e_leave_V.hr.ListLeaves" MasterPageFile="~/hr/hrMaster.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="card-box">
                    <asp:GridView ID="grd_leaves" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered dt-responsive nowrap" DataKeyNames="lid" ClientIDMode="Static" OnPreRender="grd_leaves_PreRender" ShowHeaderWhenEmpty="True">
                        <Columns>
