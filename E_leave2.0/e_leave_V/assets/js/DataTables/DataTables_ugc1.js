var TableData = function () {
    ...
    var runDataTable3 = function () {
        ...
        $('#ContentPlaceHolder1_grd_forward_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
        // modify table search input
        $('#ContentPlaceHolder1_grd_forward_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
    };
